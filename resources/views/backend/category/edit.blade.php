            ...
            <div class="box-body">
                ...
                <form action="{{route('category.update',$data['category']->id)}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="rank" class="form-control" id="rank" value="{{$data['category']->rank}}"/>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="meta_keyword" class="form-control" id="meta_keyword" cols="30"rows="3">{{$data['category']->meta_keyword}}</textarea>
                        @include('includes.single_field_validation',['field'=>'meta_keyword'])
                    </div>

                    <div class="form-group">
                        <label for="meta_description">Meta_description</label>
                        <textarea name="meta_description" class="form-control" id="meta_description" cols="30"rows="3">{{$data['category']->meta_description}}</textarea>
                        @include('includes.single_field_validation',['field'=>'meta_description'])
                    </div>

                    <div class="form-group">
                        <button type="submit" class="btn btn-success" value="Update Category"><i class="fa fa-save"></i>Update Category</button>
