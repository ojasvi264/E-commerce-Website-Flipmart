...
@section('title',$data['product_line'][0]->name . ',')
@section('content')
                ...
                <div class="row">
                    <div>
                        <ul>
                            ...
                            <li class="home"> <a href="{{route('frontend.category',$data['category']->slug)}}" title="Go to Home Page">{{$data['category']->name}}</a> <span>&rsaquo; </span> </li>
                            <li class="home"> <a href="{{route('frontend.subcategory',$data['subcategory']->slug)}}" title="Go to Home Page">{{$data['subcategory']->name}}</a> <span>&rsaquo; </span> </li>
                            <li class="product_line1601"> <strong>{{$data['product_line'][0]->name}}</strong> </li>
                        </ul>
                    </div>
                    <!--col-xs-12-->
                    ...
                    <div class="page-title">
                        <h2>{{$data['product_line'][0]->name}}</h2>
                    </div>
                    <!--row-->
                </div>
            </div>
                ...
                <div class="col-main product-grid">
                    <div class="pro-coloumn">
                        <article class="col-main">
                            ...
                            <div class="product_line-products">
